...
<h1 align="center">Scribble Jr. 1.0</h1>
...
**What platforms does Scribble Jr. support?**
...
**What versions of GameMaker does Scribble Jr. support?**

Scribble Jr. primarily supports GameMaker 2023.8, and in theory supports every version of GameMaker later than that. Later versions of GameMaker may change functionality in a way that Scribble Jr. is not forwards-compatible with, but Scribble Jr. uses only native GameMaker functions so is in the best possible position for long-term compatibility.

&nbsp;

**How is Scribble Jr. licensed? Can I use it for commercial projects?**

[Scribble Jr. is released under the MIT license](https://github.com/JujuAdams/ScribbleJunior/blob/master/LICENSE). This means you can use it for whatever purpose you want, including commercial projects. It'd mean a lot to me if you'd drop my name in your credits (Juju Adams) and/or say thanks, but you're under no obligation to do so.

&nbsp;

**I think you're missing a useful feature and I'd like you to implement it!**

Great! Please make a [feature request](https://github.com/JujuAdams/ScribbleJunior/issues). Feature requests make Scribble Jr. a more fun tool to use and gives me something to think about when I'm bored on public transport.
...
**Who made Scribble Jr.?**

Scribble Jr. is built and maintained by [@jujuadams](https://twitter.com/jujuadams) who has a long history of fiddling with text engines. Juju's worked on a lot of [commercial GameMaker games](http://www.jujuadams.com/).
